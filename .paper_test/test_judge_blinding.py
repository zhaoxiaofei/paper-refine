...
Run:  python3 .paper_test/test_judge_blinding.py
...
spec = importlib.util.spec_from_file_location("paper_blind", str(WS / "paper_pipeline.py"))
nb = importlib.util.module_from_spec(spec)
sys.modules["paper_blind"] = nb
...
def test_two_provenance_views():
    ...
    fmt = importlib.util.spec_from_file_location("fmt_blind", str(WS / "paper_docx_format.py"))
