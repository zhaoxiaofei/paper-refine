...
Run:  python3 .paper_test/test_candidates.py
...
ADAPTER_PATH = WS / "paper_redlines_adapter.py"
DOCX2PDF = WS / "docx2pdf.sh"

spec = importlib.util.spec_from_file_location("paperp", str(NP_PATH))
...
def test_c2b_interrupted_setup_can_be_restarted():
    ...
    write(root / "paper_pipeline.py", "# copied\n")
