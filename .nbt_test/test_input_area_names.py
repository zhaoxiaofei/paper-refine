...
Run:  python3 .nbt_test/test_input_area_names.py
"""
...
spec = importlib.util.spec_from_file_location("nbt_areas", str(WS / "nbt_pipeline.py"))
nb = importlib.util.module_from_spec(spec)
sys.modules["nbt_areas"] = nb
