...
against a real CLI run instead of a fixture:
    ...
    NBT_STRAY_MARKER=<substring of the run id>
    ...
    NBT_STRAY_STAGE=<substring of the run id>
    ...
    NBT_STRAY_DELIVERABLE=<run-id substring>:<basename>
...
def main() -> int:
    ...
    move_for = os.environ.get("NBT_STRAY_MARKER") or ""
    forge_for = os.environ.get("NBT_STRAY_STAGE") or ""
    deliver_for = os.environ.get("NBT_STRAY_DELIVERABLE") or ""
