...
Run:  python3 .nbt_test/test_document_recovery.py
...
place, so this file is both the repro script and the regression guard:
    ...
    NBT_WS=/tmp/nbt_base python3 .nbt_test/test_document_recovery.py   # red
"""
...
spec = importlib.util.spec_from_file_location("nbt_recovery", str(WS / "nbt_pipeline.py"))
nb = importlib.util.module_from_spec(spec)
sys.modules["nbt_recovery"] = nb
